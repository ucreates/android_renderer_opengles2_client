...
import com.ucreates.client.behaviour.RectangleBehaviour1;
...
public class RectangleActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES2Renderer renderer;
    private ArrayList<RectangleBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<RectangleBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new RectangleBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            RectangleBehaviour1 behaviour = this.behaviours.get(i);
