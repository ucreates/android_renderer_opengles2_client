...
import com.ucreates.client.behaviour.RectangleTextureBehaviour1;
...
public class RectangleTextureActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES2Renderer renderer;
    private ArrayList<RectangleTextureBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<RectangleTextureBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new RectangleTextureBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            RectangleTextureBehaviour1 behaviour = this.behaviours.get(i);
