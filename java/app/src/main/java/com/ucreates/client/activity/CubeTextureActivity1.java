...
import com.ucreates.client.behaviour.CubeTextureBehaviour1;
...
public class CubeTextureActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES2Renderer renderer;
    private ArrayList<CubeTextureBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CubeTextureBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CubeTextureBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CubeTextureBehaviour1 behaviour = this.behaviours.get(i);
