...
import com.ucreates.client.behaviour.CircleTextureBehaviour1;
...
public class CircleTextureActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES2Renderer renderer;
    private ArrayList<CircleTextureBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CircleTextureBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CircleTextureBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CircleTextureBehaviour1 behaviour = this.behaviours.get(i);
