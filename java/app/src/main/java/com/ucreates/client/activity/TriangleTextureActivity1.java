...
import com.ucreates.client.behaviour.TriangleTextureBehaviour1;
...
public class TriangleTextureActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES2Renderer renderer;
    private ArrayList<TriangleTextureBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TriangleTextureBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TriangleTextureBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TriangleTextureBehaviour1 behaviour = this.behaviours.get(i);
